  ...
  return (
    <section className="w-full h-[87vh] relative">
      <section className="w-full h-full absolute pt-6 linear backdrop-grayscale backdrop-brightness-50 flex flex-col items-center overflow-hidden">
        <motion.h1
          className="w-full h-20 text-4xl text-red-600 font-extrabold text-center"
        ...
        <motion.p
          className="text-white w-[80%] md:w-[60%] mt-8 text-wrap text-xl font-semibold"
        ...
        >
          ...
          consequat erat. Nullam at dolor a justo vehicula viverra.
        </motion.p>
        <section className="w-[80%] md:w-[60%]  h-[20vh] flex justify-center  items-center gap-8 mt-10">
          ...
          <motion.button
            ...
            whileInView={{ scale: 1, opacity: 1 }}
            viewport={{ once: true }}
            transition={{ ease: "easeOut", duration: 2, delay: 0.65 }}
          >
            See More
          </motion.button>
        </section>
