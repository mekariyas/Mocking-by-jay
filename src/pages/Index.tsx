    ...
    <>
      ...
      <section className="bg-black text-red w-full pt-2 flex flex-col items-center overflow-hidden">
        <motion.h1
          ...
          viewport={{ once: true }}
          transition={{ ease: "easeOut", duration: 2, delay: 0.85 }}
        >
          Our Artists
        </motion.h1>
      ...
      <section className="bg-black text-red w-full pt-2 flex flex-col items-center overflow-hidden">
        ...
        >
          ...
          vestibulum metus, in rhoncus augue. Vivamus dictum blandit erat, eget
          consequat erat. Lorem ipsum dolor sit amet, consectetur adipiscing
          elit. Quisque ac vestibulum metus, in rhoncus augue. Vivamus dictum
          blandit erat, eget consequat erat. Lorem ipsum dolor sit amet,
          consectetur adipiscing elit. Quisque ac vestibulum metus, in rhoncus
          augue. Vivamus dictum blandit erat, eget consequat erat.
        </motion.p>
        <motion.button
